...
SUDO = SUDO
sudo_users = {SUDO,1712951948,1033028167}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/DEVLLTEAM/DEVL/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DEVLLTEAM/Files_Teland/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevDEVLW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "IIIS1")
...
--------------------------------------------------------------------------------------------------------------
function SourceDEVL(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."DEVL1:List:Filter"..sl)
...
if not DevDEVLW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevDEVLW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevDEVLW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevDEVLW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevDEVLW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevDEVLW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevDEVLW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevDEVLW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevDEVLW(msg) then 
...
if text == 'قناه تحديثات البوت ⌯' and DevDEVLW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/TELANDTEAM) \n⌯︙[قناه السورس](t.me/IIIS1)')
end
if text == "ضع اسم للبوت ⌯" and DevDEVLW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevDEVLW(msg) then 
...
if text == 'المشتركين ⌯' and DevDEVLW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevDEVLW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevDEVLW(msg) then
...
if text == ("قائمه العام ⌯") and DevDEVLW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevDEVLW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevDEVLW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevDEVLW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevDEVLW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevDEVLW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevDEVLW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevDEVLW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevDEVLW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevDEVLW(msg) then 
...
if text and text:match("^رفع مطور @(.*)$") and DevDEVLW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevDEVLW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevDEVLW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDEVLW(msg) then
...
if DEVL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n ⌯︙'..DEVL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/IIIS1)}\n⌯︙["..DEVL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDEVLW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDEVLW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevDEVLW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevDEVLW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevDEVLW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevDEVLW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevDEVLW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevDEVLW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevDEVLW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
if t2.id_ then 
name_DEVL = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DEVL then 
names_DEVL = database:smembers(bot_id.."DEVL:blocname"..msg.chat_id_) or ""
if names_DEVL and names_DEVL[1] then 
for i=1,#names_DEVL do 
if name_DEVL:match("(.*)("..names_DEVL[i]..")(.*)") then 
...
function amir_DEVLa_new(DEVL1,DEVL2)
if DEVL2 and DEVL2.first_name_ then 
if DEVL2.first_name_:match("(.*)"..database:get(bot_id.."DEVL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DEVL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DEVL_nnn = database:get(bot_id.."DEVL:nump"..msg.chat_id_) or 5
local DEVL_nnn2 = database:get(bot_id.."DEVL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DEVL_nnn2) == tonumber(DEVL_nnn) or tonumber(DEVL_nnn2) > tonumber(DEVL_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DEVL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..DEVL2.username_.."](https://t.me/"..(DEVL2.username_ or "IIIS1")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DEVL:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(DEVL_nnn) - tonumber(DEVL_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DEVLa_new)
end
end
...
if text == 'رفع نسخه الاحتياطيه' and DevDEVLW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevDEVLW(msg) then
dofile('DEVL.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevDEVLW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDEVLW(msg) then  
function start_function(extra, result, success)
if DEVLSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevDEVLW(msg) then  
...
if DEVLSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevDEVLW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if DEVLSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDEVLW(msg) then  
function start_function(extra, result, success)
if DEVLSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevDEVLW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevDEVLW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if DEVLSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDEVLW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevDEVLW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevDEVLW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevDEVLW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDEVLW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDEVLW(msg) then  
function start_function(extra, result, success)
...
st = https.request('https://d9l9l.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://d9l9l.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "IIIS1")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'IIIS1')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'IIIS1')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
if text == 'مسح كليشه المطور' and DevDEVLW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevDEVLW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'IIIS1')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevDEVLW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevDEVLW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevDEVLW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,DEVL)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
...
if DEVLSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevDEVLW(msg) then 
...
if text == ("ردود المطور") and DevDEVLW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevDEVLW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevDEVLW(msg) then    
...
if text == 'تفعيل المغادره' and DevDEVLW(msg) then   
...
if text == 'تعطيل المغادره' and DevDEVLW(msg) then  
...
if text == 'استعاده الاوامر' and DevDEVLW(msg) then
