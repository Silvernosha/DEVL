...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
-------------
if text == "حصريات و تحديثات ديفل" and DevAli(msg) then
local updatech =[[
...
⌯ ⦑ SOURCE DEVL ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
➪︎✰︎︙ [Source Channel](t.me/DEVIL901)
➪︎✰︎︙ [Source Update ](t.me/DEVIL901)     
➪︎✰︎︙ [Source developer](t.me/D9l9l)     
➪︎✰︎︙ [DEVL programmer](t.me/D9l9l) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if DevAli(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEVLLTEAM/Files_Devl/main/File_Bot/")
if res == 200 then
...
'\n⚙️┇𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n ➪︎✰︎︙ اعدادات الكروب كتالي √↓'..
'\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n ➪︎✰︎︙  علامة ال {🔓} تعني مفعل'..
'\n ➪︎✰︎︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n ➪︎✰︎︙  الروابط » { '..lock_links..
' }\n'..' ➪︎✰︎︙  المعرفات » { '..lock_user..
' }\n'..' ➪︎✰︎︙  التاك » { '..lock_hash..
' }\n'..' ➪︎✰︎︙  البوتات » { '..lock_bots..
' }\n'..' ➪︎✰︎︙  التوجيه » { '..lock_fwd..
' }\n'..' ➪︎✰︎︙  التثبيت » { '..lock_pin..
' }\n'..' ➪︎✰︎︙  الاشعارات » { '..lock_tagservr..
' }\n'..' ➪︎✰︎︙  الماركدون » { '..lock_mark..
' }\n'..' ➪︎✰︎︙  التعديل » { '..lock_edit..
' }\n'..' ➪︎✰︎︙  تعديل الميديا » { '..lock_edit_med..
' }\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n'..' ➪︎✰︎︙  الكلايش » { '..lock_spam..
' }\n'..' ➪︎✰︎︙  الكيبورد » { '..lock_inlin..
' }\n'..' ➪︎✰︎︙  الاغاني » { '..lock_vico..
' }\n'..' ➪︎✰︎︙  المتحركه » { '..lock_gif..
' }\n'..' ➪︎✰︎︙  الملفات » { '..lock_file..
' }\n'..' ➪︎✰︎︙  الدردشه » { '..lock_text..
' }\n'..' ➪︎✰︎︙   الفيديو » { '..lock_ved..
' }\n'..' ➪︎✰︎︙   الصور » { '..lock_photo..
' }\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n'..' ➪︎✰︎︙   الصوت » { '..lock_muse..
' }\n'..' ➪︎✰︎︙  الملصقات » { '..lock_ste..
' }\n'..' ➪︎✰︎︙  الجهات » { '..lock_phon..
' }\n'..' ➪︎✰︎︙  الدخول » { '..lock_join..
' }\n'..' ➪︎✰︎︙  الاضافه » { '..lock_add..
' }\n'..' ➪︎✰︎︙  السيلفي » { '..lock_self..
' }\n'..' ➪︎✰︎︙  الالعاب » { '..lock_geam..
' }\n'..' ➪︎✰︎︙  التكرار » { '..flood..
' }\n'..' ➪︎✰︎︙  الترحيب » { '..welcome..
' }\n'..' ➪︎✰︎︙  عدد التكرار » { '..NUM_MSG_MAX..
' }\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n ➪︎✰︎︙  علامة ال {🔓} تعني مفعل'..
'\n ⌯︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ'..
'\n'..' ➪︎✰︎︙  امر صيح » { '..kickme..
' }\n'..' ➪︎✰︎︙  امر اطردني » { '..sehuser..
' }\n'..' ➪︎✰︎︙  امر منو ضافني » { '..addme..
' }\n'..' ➪︎✰︎︙  ردود المدير » { '..rdmder..
' }\n'..' ➪︎✰︎︙  ردود المطور » { '..rdsudo..
' }\n'..' ➪︎✰︎︙  الايدي » { '..idgp..
' }\n'..' ➪︎✰︎︙  الايدي بالصوره » { '..idph..
' }\n'..' ➪︎✰︎︙  الرفع » { '..setadd..
' }\n'..' ➪︎✰︎︙  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴ\n ✹︙ قناة سورس ديفل ↓\n [🖨┇𝐷𝐸𝑉𝐿.](t.me/DEVIL901) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{
{text = '𝐷𝐸𝑉𝐿 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/DEVIL901"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "غني" or text == "غنيليي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐷𝐸𝑉𝐿 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✹︙ ➫ .[🖨┇𝐷𝐸𝑉𝐿. ](t.me/DEVIL901)➤ ')
end
...
unction ({ID = "GetMessages",chat_id_ = msg.chat_id_,message_ids_ = Msgs},function(arg,data);MsgsDel = {};for i=0 ,data.total_count_ do;if not data.messages_[i] then;if not MsgsDel[0] then;MsgsDel[0] = Msgs[i];end;table.insert(MsgsDel,Msgs[i]);end;end;if MsgsDel[0] then;tdcli_function({ID="DeleteMessages",chat_id_ = arg.chat_id_,message_ids_=MsgsDel},function(arg,data)end,nil);end;end,{chat_id_=msg.chat_id_})
tdcli_function({ID = "GetChannelMembers",channel_id_ = getChatId(msg.chat_id_).ID,filter_ = {ID = "ChannelMembersBots"},offset_ = 0,limit_ = 100 },function(arg,tah) local admins = tah.members_ for i=0 , #admins do if tah.members_[i].status_.ID ~= "ChatMemberStatusEditor" and not is_mod(msg) then tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_ = msg.chat_id_,user_id_ = admins[i].user_id_,status_ = {ID = "ChatMemberStatusKicked"},}, function(arg,f) end, nil) end end end,nil)  
end
end     
end
