...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DEVL.lua')
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉"
exit 1
fi
if [ ! $token ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./DEVL.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DV", "w")  
...
sudo_users = {SUDO,1712951948,1144772977,277446721,1365465894}   
...
local UserName = (data.username_ or "DEVIL901")
local NameUser = "★︎︙ بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "★︎︙ اسم المستخدم » ["..data.first_name_.."](T.me/"..UserName..")"
...
DEVL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DEVL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DEVL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DEVL_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐷𝐸𝑉𝐿.")  
...
send(chat,msg.id_," ★︎︙  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
...
Text = '\n ★︎︙ العضــو » '..Name..'\n ★︎︙ قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n ★︎︙ العضــو » '..Name..'\n ★︎︙ قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
--------------------------------------------------------------------------------------------------------------
function SourceDEVL(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_," ★︎︙ تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
if DevSoFi(msg) then
local bl = ' ★︎︙ اهلا عزيزي آلمـطـور\n ★︎︙ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ★︎︙ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ★︎︙ من خلاال الكيبورت خاص بك\n ★︎︙ قناة  البوت [اضغط هنا](t.me/DEVIL901)'
local keyboard = {
{'الاحصائيات ★︎'},
{'تعطيل التواصل ★︎','تفعيل التواصل ★︎'},
{'ضع اسم للبوت ★︎','قائمه العام ★︎','قائمه الكتم العام ★︎'},
{'حصريات و تحديثات ديفل'},
{'المطورين ★︎','الثانويين ★︎'},
{'المشتركين ★︎','الكروبات ★︎'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك ★︎','تغير الاشتراك'},
{'ضع كليشه ستارت ★︎','حذف كليشه ستارت ★︎'},
{'اذاعه ★︎','اذاعه خاص ★︎','اذاعه بالتثبيت ★︎'},
...
{'تنظيف الكروبات ★︎','تنظيف المشتركين ★︎'},
...
SourceDEVLr = ' ★︎︙ اهلا عزيزي\n ★︎︙ انا بوت اسمي ' ..Namebot..'\n ★︎︙ اختصاصي حمايه الكروبات\n ★︎︙ من تكرار والسبام والتوجيه والخ…\n ★︎︙ لتفعيلي اتبع الاخطوات…↓\n ★︎︙ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ★︎︙ معرف المطور ['..UserName..']'
end 
send(msg.chat_id_, msg.id_, SourceDEVLr) 
end
end
...
send(msg.sender_user_id_, msg.id_,' ★︎︙ تم ارسال رسالتك\n ★︎︙ سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' ★︎︙ تم ارسال الملصق من ↓\n - '..Name
...
local DEVL_Msg = '\n ★︎︙ قام الشخص بحظر البوت'
send(msg.chat_id_, msg.id_,DEVL_Msg) 
return false  
end 
if text then    
send(id_user,msg.id_,text)    
local Name = '['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
local Text = ' ★︎︙ المستخدم » '..Name..'\n ★︎︙ تم ارسال الرساله اليه'
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
return false
end    
...
if text == 'تفعيل التواصل ★︎' and DevSoFi(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n ★︎︙ تم تفعيل التواصل ' 
else
Text = '\n ★︎︙ بالتاكيد تم تفعيل التواصل '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل ★︎' and DevSoFi(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n ★︎︙ تم تعطيل التواصل' 
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل التواصل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي ★︎' and DevSoFi(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n ★︎︙ تم تفعيل البوت الخدمي ' 
else
Text = '\n ★︎︙ بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي ★︎' and DevSoFi(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n ★︎︙ تم تعطيل البوت الخدمي' 
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء ★︎' then   
send(msg.chat_id_, msg.id_,' ★︎︙ الغاء حفظ كليشه ستارت')
...
if text == 'ضع كليشه ستارت ★︎' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ★︎︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ★︎' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ★︎︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ★︎' and DevSoFi(msg) then 
...
send(msg.chat_id_, msg.id_,' ★︎︙ اصدار  ديفل \n ★︎︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ★︎" and DevSoFi(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ★︎' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات ★︎ \n'..' ★︎︙ عدد الكروبات » {'..Groups..'}'..'\n ★︎︙  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين ★︎' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ★︎︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ★︎' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ★︎︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ★︎") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n ★︎︙ قائمة المطورين \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
...
if text == ("الثانويين ★︎") and DevSoFi(msg) then
...
-------------
if text == "حصريات و تحديثات ديفل" and DevSoFi(msg) then
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات  ديفل*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝐷𝐸𝑉𝐿.', url="t.me/DEVIL901"}},
}
...
-----------
if text == ("قائمه العام ★︎") and DevSoFi(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n ★︎︙ قائمه المحظورين عام \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if text == ("قائمه الكتم العام ★︎") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n ★︎︙ قائمة المكتومين عام \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " ★︎︙ لا يوجد مكتومين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاص ★︎" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل الان اذاعتك؟ \n ★︎︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ★︎" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل الان اذاعتك؟ \n ★︎︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ★︎" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل الان اذاعتك؟ \n ★︎︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ★︎" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ★︎" and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ★︎︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ★︎' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ★︎" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي ★︎︙ •\n• لايمكنك استخدام البوت ★︎︙ •\n• عليك الاشتراك في القناة ★︎︙ •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'★︎︙ لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'★︎︙ عدد المشتركين الان » ( '..#pv..' )\n★︎︙ تم ازالة » ( '..sendok..' ) من المشتركين\n★︎︙  الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف الكروبات ★︎" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'★︎︙ لا يوجد كروبات وهميه في البوت\n')   
else
local DEVL = (w + q)
local sendok = #group - DEVL
if q == 0 then
DEVL = ''
else
DEVL = '\n★︎︙ تم ازالة » { '..q..' } كروبات من البوت'
end
if w == 0 then
DEVLk = ''
else
DEVLk = '\n★︎︙ تم ازالة » {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'★︎︙  عدد الكروبات الان » { '..#group..' }'..DEVLk..''..DEVL..'\n★︎︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ★︎︙ العضو » ['..result.title_..'](t.me/'..(username or 'DEVIL901')..')'
status  = '\n ★︎︙ تم ترقيته مطور'
texts = usertext..status
else
texts = ' ★︎︙ لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم ترقيته مطور'
...
local DEVL1_Msg = database:get(bot_id.."DEVL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DEVL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★︎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DEVIL901')..') \n ★︎︙ '..DEVL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_, " ★︎︙ تم حفظ الاسم")
return false
end 
...
send(msg.chat_id_, msg.id_," ★︎︙ تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ★︎︙ تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ★︎︙ تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
...
send(msg.chat_id_, msg.id_,' ★︎︙ … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' ★︎︙ تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if DEVL_Msg and not Special(msg) then  
local DEVL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DEVL_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★︎︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★︎︙ ["..DEVL_Msg.."] \n")
else
send(msg.chat_id_,0," ★︎︙ العضو : {["..data.first_name_.."](T.ME/DEVIL901)}\n ★︎︙ ["..DEVL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " ★︎︙ عذرا » {[@"..data.username_.."]}\n ★︎︙ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " ★︎︙ عذرا » {["..data.first_name_.."](T.ME/DEVIL901)}\n ★︎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ★︎︙ عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' ★︎︙ عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ★︎︙ بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n ★︎︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ★︎︙ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' ★︎︙ تم تفعيل كروب جديده\n'..
'\n ★︎︙ بواسطة {'..Name..'}'..
'\n ★︎︙ ايدي الكروب {'..IdChat..'}'..
'\n ★︎︙ اسم الكروب {['..NameChat..']}'..
'\n ★︎︙ عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n ★︎︙ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' ★︎︙ بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n ★︎︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ★︎︙ تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ★︎︙ تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n ★︎︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ★︎︙ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
if text == "حذف رساله الاشتراك ★︎" and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ★︎︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ★︎$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ★︎︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ★︎" and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ★︎" and DevSoFi(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ★︎︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ★︎" and DevSoFi(msg) then  
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '★︎︙ تم كتم الاسم '..BlNe)
database:sadd(bot_id.."DEVL:blocname"..msg.chat_id_, BlNe)
end
...
send(msg.chat_id_, msg.id_, '★︎︙ تم الغاء كتم الاسم '..delBn)
database:srem(bot_id.."DEVL:blocname"..msg.chat_id_, delBn)
end

if text == "مسح الاسماء المكتومه" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
database:del(bot_id.."DEVL:blocname"..msg.chat_id_)
texts = "★︎︙ تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
if text == "الاسماء المكتومه" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
local All_name = database:smembers(bot_id.."DEVL:blocname"..msg.chat_id_)
t = "\n★︎︙ قائمة الاسماء المكتومه \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻 \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "★︎︙ لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '★︎︙ تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل الاسماء المكتومه')
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."DEVL:blocname"..msg.chat_id_) or ""
...
send(msg.chat_id_, msg.id_,'★︎︙ تم تعيين '..teh..' كتوحيد للمجموعه')
database:set(bot_id.."DEVL:teh"..msg.chat_id_,teh)
end
...
send(msg.chat_id_, msg.id_,'★︎︙ تم تعين  '..nump..' عدد الكتم')
database:set(bot_id.."DEVL:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DEVL:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DEVL:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'★︎︙ التوحيد '..s1..'\n ★︎︙ عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '★︎︙ تم تفعيل التوحيد')
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DEVL:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."DEVL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DEVL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."DEVL:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."DEVL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DEVL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "★︎︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "DEVIL901")..")\n★︎︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DEVL:teh"..msg.chat_id_).."} بجانب اسمك\n★︎︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل تنبيه الاسماء')
...
local DEVLChengName = database:get(bot_id.."DEVL:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DEVLChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DEVLChengName..']')
database:del(bot_id.."DEVL:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DEVLChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DEVL:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل تنبيه المعرف')
...
if data.id_ then 
if data.id_ ~= bot_id then
local DEVLChengUserName = database:get(bot_id.."DEVL:Cheng:UserName"..data.id_)
if not data.username_ then 
if DEVLChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DEVLChengUserName..']')
database:del(bot_id.."DEVL:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DEVLChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DEVL:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, '*★︎︙تم تفعيل الرسائل اليوميه*')
database:set(bot_id.."msg:match:"..msg.chat_id_,true)
end
if text == "تعطيل الرسائل اليوميه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*★︎︙تم تعطيل الرسائل اليوميه*')
...
get_msg = database:get(bot_id.."msg:match:"..msg.sender_user_id_..":"..msg.chat_id_) or 0
send(msg.chat_id_, msg.id_,"*★︎︙عدد رسائلك الكلي هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
send(msg.chat_id_, msg.id_,"*★︎︙عدد رسائل الشخص الكلي هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '★︎︙ تم تعطيل تنبيه الصور')
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DEVLChengPhoto = database:get(bot_id.."DEVL:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DEVLChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DEVL:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DEVLChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DEVL:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
★︎ ↬⦑ SOURCE DEVL ⦒ 
==================
★︎ ↬︙ [Source Channel](http://t.me/DEVIL901)
==================
★︎ ↬︙ [Source Update](http://t.me/DEVIL901)      
==================
★︎ ↬︙ [Source developer](http://t.me/D9l9l)    
===================
★︎ ↬︙ [DEVL programmer](http://t.me/D9l9l)
===================
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
send(msg.chat_id_, msg.id_,' ★︎︙ ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
...
send(msg.chat_id_, msg.id_, '*★︎︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*★︎︙تم تفعيل التنظيف التلقائي* ')
return false
end
if text == "تعطيل تنظيف التلقائي" and BasicConstructor(msg) then
database:del(bot_id.."LoMsg"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '*★︎︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*★︎︙تم تعطيل التنظيف التلقائي* ')
return false
end
--------------------------------------------------------------------------------------------------------------
...
Text = ' ★︎︙ تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ تم تعطيل نسبه الانوثه'
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' ★︎︙ تم تفعيل امر كول'
database:del(bot_id..'Speak:after:me'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل امر كول'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ تم تعطيل امر غنيلي'
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل امر غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,' ★︎︙ تم قفل التكرار')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,' ★︎︙ تم قفل التكرار بالتقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,' ★︎︙ تم قفل التكرار بالكتم')
...
dofile('DEVL.lua')  
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تحديث جميع الملفات') 
end 
...
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_," ★︎∫ عذرا الملف لايدعم  ديفل \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " ★︎∫ بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " ★︎∫ الملف » "..file.."\n ★︎∫ تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/DEVLLTEAM/Files_Devl/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," ★︎∫ تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ لا ����ستطيع استخدام البوت \n  ★︎︙ يرجى الاشتراك بالقناه اولا \n  ★︎︙ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if #list == 0 then
t = " ★︎︙ لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
Text = ' ★︎︙ بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ تم تعطيل امر تحويل'
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local UserName = (b.username_ or "SRC-DEVL")
send(msg.chat_id_, msg.id_," ★︎︙ منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
function Function_DEVL(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DEVL, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DEVL, nil)
return false 
end
...
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n★︎︙ قائمة مطورين الثانويين للبوت \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," ★︎︙ لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," ★︎︙ تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ★︎︙ لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة مميزين الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★︎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★︎︙ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة مطايه الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ★︎︙ تم رفع العضو مطي في الكروب \n ★︎︙ تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل العضو مطي في الكروب\n ★︎︙ تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح جميع الحاتات')
end
if text == ("تاك للحاتات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ★︎︙ قائمه حاتات الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ★︎︙ تم رفع العضــو الحاته في الكروب \n ★︎︙ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل العضــو الحاته من الكروب\n ★︎︙ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح جميع الصاكين')
end
if text == ("تاك للصاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n ★︎︙ قائمه صاكين الكروب \nٴ𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ★︎︙ تم رفع العضــو الصاك في الكروب \n ★︎︙ تعال حبي الصاك نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل العضــو الصاك من الكروب\n ★︎︙ مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة صخوله الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع المتهم صخل بالكروب\n ★︎︙ الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة الجلاب الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع جلب في الكروب\n ★︎︙ تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة القروده الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع قرد في الكروب\n ★︎︙ تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع ضلع في الكروب\n ★︎︙ تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل ضلع من الكروب\n ★︎︙ بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع ضلعه في الكروب\n ★︎︙ تعاي صرتي من ضلعاتي تمكيجي وخل نروح للمول نرقم صاكين'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل ضلعه من الكروب\n ★︎︙ دمشي ولي ملطخه وجهه تلطخ وتريد ترقم صاكين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة البقرات الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع بقره في الكروب\n ★︎︙ ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل بقره من الكروب\n ★︎︙ تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة الطليان الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع الطلي في الكروب\n ★︎︙ طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع زواحف')
end
if text == ("تاك للزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة الزواحف الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل زاحف من الكروب\n ★︎︙ هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم تنزيل جميع جريزي')
end
if text == ("تاك للجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ★︎︙ قائمة الجريذيه الكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local  statuss  = '\n ★︎︙ تم رفع جريذي في الكروب\n ★︎︙ خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح جميع الكلوب')
end
if text == ("تاك للكلوب") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ★︎︙ قائمه الكلوب بالكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ★︎︙ تم رفع العضــو بكلبك في الكروب \n ★︎︙  رفعتك بكلبي لا تجرحه '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تنزيل العضــو كلبك من الكروب\n ★︎︙ نزلتك من كلبي مو كتلك لا تجرحني'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ★︎︙ لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ★︎︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n ★︎︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n ★︎︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' ★︎︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' ★︎︙ انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ★︎︙ لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ★︎︙ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ★︎︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ★︎︙ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " ★︎︙ لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙ تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★︎︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
status  = '\n ★︎︙  الايدي » `'..result.sender_user_id_..'`\n ★︎︙  تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n⚙️┇𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n ★︎︙ اعدادات الكروب كتالي √↓'..
'\nء𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻'..
...
' }\n'..' ★︎︙  التكرار » { '..flood..
' }\n'..' ★︎︙  الترحيب » { '..welcome..
' }\n'..' ★︎︙  عدد التكرار » { '..NUM_MSG_MAX..
' }\nء𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻'..
'\n ★︎︙  علامة ال {🔓} تعني مفعل'..
'\n ★︎︙  علامة ال {🔐} تعني معطل'..
'\nء𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻'..
'\n'..' ★︎︙  امر صيح » { '..kickme..
' }\n'..' ★︎︙  امر اطردني » { '..sehuser..
' }\n'..' ★︎︙  امر منو ضافني » { '..addme..
' }\n'..' ★︎︙  ردود المدير » { '..rdmder..
' }\n'..' ★︎︙  ردود المطور » { '..rdsudo..
' }\n'..' ★︎︙  الايدي » { '..idgp..
' }\n'..' ★︎︙  الايدي بالصوره » { '..idph..
' }\n'..' ★︎︙  الرفع » { '..setadd..
' }\n'..' ★︎︙  الحظر » { '..banm..' }\n\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n ★︎︙ قناة  ديفل ↓\n [ 𝙎𝙊𝙐𝙍𝘾𝞝 𝗗𝗘𝗩𝗟.](t.me/DEVIL901) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," ★︎︙ عذرآ تم قفل التثبيت")  
return false  
end
...
send(msg.chat_id_,msg.id_," ★︎︙ لا توجد رساله مثبته")  
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," ★︎︙ عذرآ تم قفل الثبيت")  
return false  
end
...
send(msg.chat_id_,msg.id_," ★︎︙ حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," ★︎︙ تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ★︎︙ تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم ازالة صورة الكروب') 
end
return false  
end
...
GetWelcome = ' ★︎︙ لم يتم تعيين ترحيب للكروب'
end 
...
Text = ' *★︎︙تم تفعيل التحقق*'
else
Text = ' *★︎︙بالتاكيد تم تفعيل التحقق*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التحقق' and Manager(msg) then  
if not database:get(bot_id..'CAPTCHA'..msg.chat_id_) then
Text = '\n *★︎︙بالتاكيد تم تعطيل التحقق*'
else
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم تفعيل ترحيب الكروب') 
return false  
end
...
database:del(bot_id..'Chek:Welcome'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ★︎︙ تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," ★︎︙ ارسل الكلمه لمنعها")  
database:set(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ★︎︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DEVL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DEVL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ★︎︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DEVL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DEVL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DEVL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ★︎︙ ارسل الكلمه الان")  
database:set(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DEVL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DEVL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DEVL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DEVL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DEVL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DEVL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ★︎︙ قائمة المنع \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do  
local DEVL_Msg = database:get(bot_id.."DEVL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DEVL_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح قائمه منع المتحركات')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح قائمه منع الصور')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح قائمه منع الملصقات')  
end
------------------

if text == 'مسح كليشه المطور' and DevSoFi(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح كليشه المطور')
end
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," ★︎︙ تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ★︎︙ لا توجد بوتات في الكروب")
else
...
send(msg.chat_id_, msg.id_," ★︎︙ تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," ★︎︙ تم ازالة قوانين الكروب")  
...
send(msg.chat_id_, msg.id_," ★︎︙ لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم طرد المحذوفين')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_, " ★︎︙ ارسل نوع الرتبه \n ★︎︙ {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* ★︎︙ تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n ★︎︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* ★︎︙ تستطيع اضافه صلاحيات {مميز - عضو} \n ★︎︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* ★︎︙  تستطيع اضافه صلاحيات {عضو} \n ★︎︙ ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " ★︎︙ تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★︎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVIL901')..')'..'\n ★︎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' ★︎︙ عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'★︎︙تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'★︎︙ تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"★︎︙ تم تنظيف جميع الميديا")
end
...
send(msg.chat_id_, msg.id_,'★︎︙ تم تنظيف جميع الرسائل المعدله')
end
...
send(msg.chat_id_, msg.id_,'['..DEVL_Msg[math.random(#DEVL_Msg)]..']') 
return false
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ★︎︙ ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' ★︎︙ تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"★︎︙ لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n★︎︙ تم تنزيل الشخص من الرتب التاليه \n★︎︙  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n★︎︙  عذرا العضو لايملك رتبه \n")
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ★︎︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:DEVL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:DEVL:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DEVL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"★︎︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:DEVL:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:DEVL:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:DEVL:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:DEVL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:DEVL:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:DEVL:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:DEVL:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:DEVL:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:DEVL:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:DEVL:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"★︎︙تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'★︎︙وينك وين القب ') 
else
...
send(msg.chat_id_, msg.id_,'\n ★︎︙صلاحيات البوت هي\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n★︎︙  علامة ال {✔️} تعني مفعل\n★︎︙  علامة ال {✖} تعني غير مفعل\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n★︎︙تغير معلومات المجموعة ↞ '..INf..'\n★︎︙حذف الرسائل ↞ '..DEL..'\n★︎︙حظر المستخدمين ↞ '..REs..'\n★︎︙دعوة المستخدمين ↞ '..INv..'\n★︎︙ثتبيت الرسالة ↞ '..Pin..'\n★︎︙اضافة مشرفين ↞ '..PRo)   
end
end
if text == "تعطيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_, '★︎ تم تعطيل الانستا')
database:set(bot_id.."DEVIL901:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'★︎ تم تفعيل الانستا')
database:set(bot_id.."DEVIL901:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."DEVIL901:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."DEVIL901:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★︎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."DEVIL901:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "★︎︙تم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."DEVIL901:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري  ديفل يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n★︎︙المستخدم ~ ["..User_id .."] يصيح المشرفين \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
k = 0
...
database:set(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"★︎︙ارسل الرد الذي اريد اضافته")
end
...
database:set(bot_id.."botss:DEVL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"★︎︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:DEVL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEVL:Add:Rd:Sudo:Text"..test, text)  
end  
send(msg.chat_id_, msg.id_,"★︎︙تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
local test = database:get(bot_id.."botss:DEVL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEVL:Add:Rd:Sudo:Text1"..test, text)  
end  
send(msg.chat_id_, msg.id_,"★︎︙تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
local test = database:get(bot_id.."botss:DEVL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DEVL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEVL:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:DEVL:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DEVL:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DEVL:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديفل').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,' ★︎︙ تم مغادرة الكروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' ★︎︙ تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' ★︎︙ تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' ★︎︙ بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n ★︎︙ بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ تم تفعيل الايدي بالصور' 
else
Text = '\n ★︎︙ بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ ايديه ~⪼ '..iduser..'\n ★︎︙ معرفه ~⪼ '..username..'\n ★︎︙ رتبته ~⪼ '..rtp..'\n ★︎︙ تعديلاته ~⪼ '..edit..'\n ★︎︙ نقاطه ~⪼ '..NUMPGAME..'\n ★︎︙ جهاته ~⪼ '..Contact..'\n ★︎︙ رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' ★︎︙ ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVIL901')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' ★︎︙ الايدي » ('..iduser..')\n ★︎︙ المعرف » ('..username..')\n ★︎︙ الرتبه » ('..rtp..')\n ★︎︙ نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_, '\n ★︎︙ عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' ★︎︙ تم طردك من الكروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' ★︎︙ لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ★︎︙ تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ★︎︙ الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ★︎︙ انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' ★︎︙ تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' ★︎︙ تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ تم تعطيل امر منو ضافني'
else
Text = '\n ★︎︙ بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' ★︎︙ تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ★︎︙ تم تنزيل الكل من الرتب الاتيه \n ★︎︙ المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\n ★︎︙ بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' ★︎︙ تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' ★︎︙ بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ★︎︙ بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," ★︎︙ الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ★︎︙ عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'★︎︙ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
local rtpg = rtpa
local sofia = {
" ★︎︙ اروح فـدوه للـحلوين",
" ★︎︙ حلوة حبيبي معليك بالمضغوطين",
" ★︎︙ جهرتك منورة ",
" ★︎︙ هاي شكد حلو انتة",
" ★︎︙ اصلا صوفي احلئ",
" ★︎︙ اصلا روظي احلئ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n ★︎︙ ايديك ~⪼ '..msg.sender_user_id_..'\n ★︎︙ معرفك ~⪼ '..username..'\n ★︎︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ★︎︙ موقعك ~⪼ '..rtpa..'\n ★︎︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n ★︎︙ رسائلك ~⪼ '..Msguser..'\n ★︎︙ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n ★︎︙ السحكات ~⪼ '..edit..'\n ★︎︙ نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n ★︎︙ ايديك ~⪼ '..msg.sender_user_id_..'\n ★︎︙ معرفك ~⪼ '..username..'\n ★︎︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ★︎︙ موقعك ~⪼ '..rtpa..'\n ★︎︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n ★︎︙ رسائلك ~⪼ '..Msguser..'\n ★︎︙ نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n ★︎︙ السحكات ~⪼ '..edit..'\n ★︎︙ نقاطك ~⪼ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n ★︎︙ الصوره ~⪼ ليس لديك صور في حسابك'..'[\n ★︎︙ ايديك ~⪼ '..msg.sender_user_id_..'\n ★︎︙ معرفك ~⪼ '..username..'\n ★︎︙ رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ★︎︙ موقعك ~⪼ '..rtpa..'\n ★︎︙ تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n ★︎︙ رسائلك ~⪼ '..Msguser..'\n ★︎︙ نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n ★︎︙ السحكات ~⪼ '..edit..'\n ★︎︙ نقاطك ~⪼ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' ★︎︙  ليس لديك سحكات'
else
Text = ' ★︎︙ عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' ★︎︙ تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' ★︎︙ لم تقم بأضافه احد'
else
Text = ' ★︎︙ عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
DEVLdx(msg.chat_id_, msg.id_, ' ★︎︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ★︎︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ★︎︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ★︎︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,  1, "★︎| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ★︎︙ ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ★︎︙ ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," ★︎︙ تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' ★︎︙ لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' ★︎︙ عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,' ★︎︙ ليس لديك نقاط في الالعاب\n ★︎︙ اذا كنت تريد ربح نقاط \n ★︎︙ ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n ★︎︙ ليس لديك نقاط في هذه لعبه \n ★︎︙ لزيادة نقاطك في اللعبه \n ★︎︙ ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' ★︎︙ تم خصم *» { '..NUMPY..' }* من نقاطك \n ★︎︙ وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n ★︎︙ اهلا عزيزي البوت هنا ادمن'..'\n ★︎︙ وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n ★︎︙ تغير معلومات الكروب ↞ ❴ '..info..' ❵'..'\n ★︎︙ حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n ★︎︙ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ★︎︙ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n ★︎︙ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n ★︎︙ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," ★︎︙ تم تغير رد المالك الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' ★︎︙ تم حفظ الكليشه')
...
send(msg.chat_id_, msg.id_,'*★︎︙تم تعطيل الالعاب الاحترافيه*')
end
...
send(msg.chat_id_, msg.id_,'*★︎︙تم تفعيل الالعاب الاحترافيه*')
end
...
{{text = 'DEVL 𝑇𝐸𝐴𝑀', url="t.me/DEVLTEAM"}},
{{text = 'مطور السورس', url="t.me/D9l9l"}},
}
send_inlin_key(msg.chat_id_," *★︎︙قائمه الالعاب الاحترافيه اضغط للعب*",_key,msg.id_)
else
send(msg.chat_id_, msg.id_," *★︎︙الالعاب الاحترافيه معطله في الوقت الحالي .*")
end
end
----------------------------------------------------------------------------
...
{
{text = ' 𝙎??𝙐𝙍𝘾𝞝 𝗗𝗘𝗩𝗟', url="t.me/DEVIL901"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n★︎︙ ➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝗗𝗘𝗩𝗟. ](t.me/DEVIL901)➤ ')
end
...
send(msg.chat_id_, msg.id_,' ★︎︙ تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' ★︎︙ لا يوجد امر بهاذا الاسم')  
end
...
DEVL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DEVL)
...
send(msg.chat_id_,0,''..t..'\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗗𝗘𝗩𝗟•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n ★︎︙ تم التعديل على الميديا\n ★︎︙ الشخص الي قام بالتعديل\n ★︎︙ ايدي الشخص ◂ '..result.sender_user_id_..'\n ★︎︙ معرف الشخص»{ '..users..' }') 
end,nil)
...
------------------------------------------------------------------------
local DEVLAbot = database:get(bot_id.."DEVL1:Add:Filter:Rp2"..text..result.chat_id_)   
if DEVLAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★︎︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★︎︙ ["..DEVLAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DEVL1_Msg = database:get(bot_id.."DEVL1:Add:Filter:Rp2"..text..result.chat_id_)   
if DEVL1_Msg then    
send(msg.chat_id_, msg.id_," ★︎︙ "..DEVL1_Msg)
