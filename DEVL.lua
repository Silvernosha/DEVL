...
sudo_users = {SUDO,1712951948,277446721}   
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
database:del(bot_id..'Set:to announce'..msg.chat_id_)
to announce_Rand = {'العراق','سوريا','المانيا','النمسا','اليابان','الصين','هولندا','تركيا','فرنسا','امريكا','الكويت','السويد','فلسطين','السودان','ايران','الامارات','باكستان','اليمن','الهند','مصر','البرازيل','البحرين','الجزائر','المغرب','السعوديه'}
name = to announce_Rand[math.random(#to announce_Rand)]
database:set(bot_id..'to announce'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..'to announce'..msg.chat_id_) or '')..'' and not database:get(bot_id..'Set:to announce'..msg.chat_id_) then
if not database:get(bot_id..'Set:to announce'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,' ❃∫ الف مبروك لقد فزت \n ❃∫ للعب مره اخره ارسل »{ اعلام }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:to announce'..msg.chat_id_,true)
end
